...
//         const result = Object.keys(userData).find(password =>
//             password === searchTerm
//         );
...
//                         <p style={{ fontSize: '22px', fontWeight: 'bold' }}><strong>HEIGHT:</strong> {userData[selectedUser]?.['Cao']}</p>
//                         <p style={{ fontSize: '22px', fontWeight: 'bold' }}><strong>WEIGHT:</strong> {userData[selectedUser]?.Nặng}</p>
//                         <p style={{ fontSize: '22px', fontWeight: 'bold' }}><strong>LOCATION:</strong> {userData[selectedUser]?.['Nơi sống']}</p>
//                         <button style={{ backgroundColor: '#ff0000', color: '#fff', marginRight: '10px' }}
...
//                                 key={password}
//                                 className="user-card"
//                                 onClick={() => handleUserClick(password)}
//                             >
//                                 <div className="avatar-placeholder">
//                                     <img src={MyImage} alt="Avatar" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//                                 </div>
